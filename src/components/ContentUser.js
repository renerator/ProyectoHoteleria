...
import SectionHeader532 from "./SectionHeader532";
import SectionHeader19 from "./SectionHeader19";
    ...
    >
      <Container overflow="auto">
        ...
        <Box textAlign="center" mt={2}>
          <BaseUser section={router.query.section} key={router.query.section} />
        </Box>
      </Container>
    </Section>
  );
